...
export default function Hero() {
  ...
  return (
    <div className="relative h-screen min-h-screen w-screen overflow-x-hidden bg-[url('/assets/home/hero/landing_bg.jpg')] bg-cover bg-[left_210vw_bottom_-50px] p-4 sm:p-6 md:bg-[center] md:p-8 lg:p-12 xl:p-16">
