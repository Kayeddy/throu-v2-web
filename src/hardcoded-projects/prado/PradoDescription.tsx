...
import { PRADO_PROJECT_DESCRIPTION_IMAGES, PRADO_PROJECT_NAME } from "@/hardcoded-projects/prado";

interface ProjectDescriptionTabProps {
  projectLocation: ProjectAttribute | undefined;
}

export default function PradoDescription({
  projectLocation,
  ...
  return (
    <div className="flex w-full min-w-[50vw] flex-col items-start justify-start gap-6 text-primary dark:text-light lg:w-[50vw]">
      <h1 className="font-sen text-4xl font-bold">{PRADO_PROJECT_NAME}</h1>
      ...
      <Image
        src={PRADO_PROJECT_DESCRIPTION_IMAGES[0]}
      ...
      <Image
        src={PRADO_PROJECT_DESCRIPTION_IMAGES[3]}
      ...
      <Image
        src={PRADO_PROJECT_DESCRIPTION_IMAGES[4]}
